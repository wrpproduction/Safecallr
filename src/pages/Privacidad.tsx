...
export default function Privacidad() {
  ...
  return (
    <div id="privacy-policy-es-page" className="min-h-screen bg-[#FAFBFD] text-[#0F1B3D] font-sans">
      {/* Header Bar */}
      <header id="privacy-es-header" className="bg-[#0F1B3D] text-white py-14 px-6 relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          ...
          <h1 id="privacy-es-main-title" className="text-3xl md:text-4xl font-extrabold tracking-tight mb-4">
            Política de privacidad
          </h1>
          <p className="text-[#B9C3DC] text-sm">
            Última actualización: <strong className="text-[#3DFFA0] font-semibold">16 de julio de 2026</strong> · Versión 1.0
          </p>
        </div>
      </header>
      ...
      <main id="privacy-es-main-content" className="max-w-3xl mx-auto px-6 py-10 md:py-16">
        ...
        {/* Intro */}
        <div id="privacy-es-intro-card" className="border-l-4 border-[#3DFFA0] pl-6 py-2 mb-6 text-[#2A3A66] text-lg leading-relaxed italic">
          <p>
        ...
        <div id="privacy-es-prevalence" className="bg-[#F1F5F9] border border-[#E3E8F2] rounded-xl p-4 mb-10 text-sm text-[#2A3A66] leading-relaxed">
        ...
        {/* Table of Contents */}
        <nav id="privacy-es-toc" className="bg-white border border-[#E3E8F2] rounded-xl p-6 mb-12 shadow-sm">
          ...
          <ol className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2 text-sm">
            ...
            <li>
              <a href="#datos" onClick={(e) => scrollToId(e, "datos")} className="hover:text-[#0E9C5C] hover:underline transition-colors block py-0.5">
                2. Datos que recogemos
              </a>
            </li>
            <li>
              <a href="#no-recoge" onClick={(e) => scrollToId(e, "no-recoge")} className="hover:text-[#0E9C5C] hover:underline transition-colors block py-0.5">
                3. Lo que SafeCallr no recoge
              </a>
            </li>
            <li>
              <a href="#finalidades" onClick={(e) => scrollToId(e, "finalidades")} className="hover:text-[#0E9C5C] hover:underline transition-colors block py-0.5">
                4. Finalidades y bases jurídicas
              </a>
            </li>
            <li>
              <a href="#conservacion" onClick={(e) => scrollToId(e, "conservacion")} className="hover:text-[#0E9C5C] hover:underline transition-colors block py-0.5">
                5. Plazos de conservación
              </a>
            </li>
            <li>
              <a href="#destinatarios" onClick={(e) => scrollToId(e, "destinatarios")} className="hover:text-[#0E9C5C] hover:underline transition-colors block py-0.5">
                6. Destinatarios y encargados del tratamiento
              </a>
            </li>
            <li>
              <a href="#transferencias" onClick={(e) => scrollToId(e, "transferencias")} className="hover:text-[#0E9C5C] hover:underline transition-colors block py-0.5">
                7. Transferencias fuera de la Unión Europea
              </a>
            </li>
            <li>
              <a href="#seguridad" onClick={(e) => scrollToId(e, "seguridad")} className="hover:text-[#0E9C5C] hover:underline transition-colors block py-0.5">
                8. Seguridad
              </a>
            </li>
            <li>
              <a href="#derechos" onClick={(e) => scrollToId(e, "derechos")} className="hover:text-[#0E9C5C] hover:underline transition-colors block py-0.5">
                9. Sus derechos
              </a>
            </li>
            <li>
              <a href="#edad" onClick={(e) => scrollToId(e, "edad")} className="hover:text-[#0E9C5C] hover:underline transition-colors block py-0.5">
                10. Edad mínima
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="#modificaciones" onClick={(e) => scrollToId(e, "modificaciones")} className="hover:text-[#0E9C5C] hover:underline transition-colors block py-0.5">
                12. Modificaciones de esta política
              </a>
            </li>
            <li>
              <a href="#contacto" onClick={(e) => scrollToId(e, "contacto")} className="hover:text-[#0E9C5C] hover:underline transition-colors block py-0.5">
                13. Contacto
              </a>
            </li>
          </ol>
        ...
        <div className="space-y-12 leading-relaxed text-base">
          ...
          <section id="responsable" className="scroll-mt-6">
            ...
            <div className="space-y-3">
              ...
              <p className="bg-white border border-[#E3E8F2] rounded-xl p-4 shadow-sm">
                <strong>MOTIOON</strong>, sociedad por acciones simplificada unipersonal de derecho francés (SASU)<br />
          ...
          <section id="datos" className="scroll-mt-6">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-bold text-[#0F1B3D] mb-2">2.1 Datos de la cuenta (todos los usuarios)</h3>
                <ul className="list-disc pl-6 space-y-2">
                  <li><strong>Identidad:</strong> nombre completo;</li>
                  <li><strong>Datos de contacto:</strong> dirección de correo electrónico, número de teléfono;</li>
                  <li><strong>Autenticación:</strong> contraseña (almacenada exclusivamente de forma cifrada/hasheada — nunca tenemos acceso a su contraseña en claro);</li>
                  <li><strong>Tipo de cuenta:</strong> particular o profesional.</li>
                </ul>
              </div>

              <div>
                <h3 className="text-lg font-bold text-[#0F1B3D] mb-2">2.2 Datos de verificación profesional (solo cuentas profesionales)</h3>
                <p>
              ...
              <div>
                <h3 className="text-lg font-bold text-[#0F1B3D] mb-2">2.3 Datos de uso del servicio</h3>
                <ul className="list-disc pl-6 space-y-2">
                  <li><strong>Contactos seguros:</strong> la lista de usuarios de SafeCallr con los que ha establecido una relación de verificación;</li>
                  <li><strong>Historial de verificaciones:</strong> fecha, interlocutor y resultado (identidad confirmada o no) de cada solicitud de autenticación;</li>
                  <li><strong>Códigos de verificación:</strong> los códigos de un solo uso generados durante una solicitud de autenticación, que expiran automáticamente en un plazo breve;</li>
                  <li><strong>Preferencias:</strong> idioma de la aplicación.</li>
                </ul>
              </div>

              <div>
                <h3 className="text-lg font-bold text-[#0F1B3D] mb-2">2.4 Datos técnicos</h3>
                <ul className="list-disc pl-6 space-y-2">
                  <li><strong>Token de notificaciones push (token FCM):</strong> identificador técnico que permite entregar las notificaciones de autenticación en su dispositivo;</li>
                  <li><strong>Plataforma utilizada:</strong> iOS, Android o web;</li>
                  <li><strong>Registros técnicos:</strong> registros de conexión y de errores estrictamente necesarios para el funcionamiento, la seguridad y el mantenimiento del servicio.</li>
                </ul>
              </div>
            </div>
          </section>
              ...
              <table className="w-full text-left text-sm border-collapse">
                <thead>
                  <tr className="bg-[#0F1B3D] text-white">
                    <th className="p-4 font-semibold border-b border-[#E3E8F2]">Finalidad</th>
                    <th className="p-4 font-semibold border-b border-[#E3E8F2]">Datos afectados</th>
                    <th className="p-4 font-semibold border-b border-[#E3E8F2]">Base jurídica (art. 6 RGPD)</th>
                  </tr>
                </thead>
          ...
          <section id="conservacion" className="scroll-mt-6">
            ...
            <div className="overflow-x-auto border border-[#E3E8F2] rounded-xl shadow-sm bg-white">
              <table className="w-full text-left text-sm border-collapse">
                <thead>
                  <tr className="bg-[#0F1B3D] text-white">
                    <th className="p-4 font-semibold border-b border-[#E3E8F2]">Datos</th>
                    <th className="p-4 font-semibold border-b border-[#E3E8F2]">Plazo de conservación</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-[#E3E8F2] text-[#2A3A66]">
                  <tr>
          ...
          <section id="destinatarios" className="scroll-mt-6">
            ...
            <div className="overflow-x-auto border border-[#E3E8F2] rounded-xl shadow-sm bg-white mb-6">
              <table className="w-full text-left text-sm border-collapse">
                <thead>
                  <tr className="bg-[#0F1B3D] text-white">
                    <th className="p-4 font-semibold border-b border-[#E3E8F2]">Proveedor</th>
                    <th className="p-4 font-semibold border-b border-[#E3E8F2]">Función</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-[#E3E8F2] text-[#2A3A66]">
                  <tr>
          ...
          <section id="derechos" className="scroll-mt-6">
            ...
            <ul className="list-disc pl-6 space-y-2 mb-4">
              <li><strong>Derecho de acceso:</strong> obtener una copia de los datos que tenemos sobre usted;</li>
              <li><strong>Derecho de rectificación:</strong> hacer corregir datos inexacts o incompletos;</li>
              <li><strong>Derecho de supresión:</strong> solicitar la eliminación de sus datos, en particular mediante la supresión de su cuenta;</li>
              <li><strong>Derecho a la limitación:</strong> solicitar la suspensión temporal del tratamiento de sus datos;</li>
              <li><strong>Derecho a la portabilidad:</strong> recibir sus datos en un formato estructurado y de uso común;</li>
              <li><strong>Derecho de oposición:</strong> oponerse a los tratamientos basados en nuestro interés legítimo, por motivos relacionados con su situación particular;</li>
              <li><strong>Directives post mortem:</strong> definir directrices sobre el destino de sus datos tras su fallecimiento, conforme al derecho francés.</li>
            </ul>
            <p className="mb-3">
          ...
          <section id="edad" className="scroll-mt-6">
            ...
            <p>
              SafeCallr está reservado a personas de <strong>18 años o más</strong>. Al crear una cuenta, usted confirma tener al menos 18 años. Si constatamos que una cuenta ha sido creada por un menor, procederemos a su supresión.
            </p>
          </section>
      ...
      {/* Footer */}
      <footer id="privacy-es-footer" className="border-t border-[#E3E8F2] py-8 px-6 text-center text-sm text-[#2A3A66] bg-white">
