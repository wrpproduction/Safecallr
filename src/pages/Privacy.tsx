...
export default function Privacy() {
  ...
  return (
    <div id="privacy-policy-en-page" className="min-h-screen bg-[#0A1128] text-[#E8ECF7] font-sans">
      {/* Header Bar */}
      <header id="privacy-en-header" className="bg-[#0F1B3D] text-white py-14 px-6 relative overflow-hidden border-b border-[#263462]">
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          ...
          <h1 id="privacy-en-main-title" className="text-3xl md:text-4xl font-extrabold tracking-tight mb-4 text-[#FFFFFF]">
            Privacy Policy
          </h1>
          <p className="text-[#9FACD1] text-sm">
            Last updated: <strong className="text-[#FFFFFF] font-semibold">July 16, 2026</strong> · Version 1.0
          </p>
        </div>
      </header>
      ...
      <main id="privacy-en-main-content" className="max-w-3xl mx-auto px-6 py-10 md:py-16">
        ...
        {/* Intro */}
        <div id="privacy-en-intro-card" className="border-l-4 border-[#3DFFA0] pl-6 py-2 mb-6 text-[#9FACD1] text-lg leading-relaxed italic">
          <p>
        ...
        <div id="privacy-en-prevalence" className="bg-[#131E42] border border-[#263462] rounded-xl p-4 mb-10 text-sm text-[#9FACD1] leading-relaxed">
        ...
        {/* Table of Contents */}
        <nav id="privacy-en-toc" className="bg-[#131E42] border border-[#263462] rounded-xl p-6 mb-12 shadow-sm">
          ...
          <ol className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2 text-sm">
            <li>
              <a href="#controller" onClick={(e) => scrollToId(e, "controller")} className="text-[#3DFFA0] hover:text-white hover:underline transition-colors block py-0.5">
                1. Data controller
              </a>
            </li>
            <li>
              <a href="#data" onClick={(e) => scrollToId(e, "data")} className="text-[#3DFFA0] hover:text-white hover:underline transition-colors block py-0.5">
                2. Data we collect
              </a>
            </li>
            <li>
              <a href="#no-collect" onClick={(e) => scrollToId(e, "no-collect")} className="text-[#3DFFA0] hover:text-white hover:underline transition-colors block py-0.5">
                3. What SafeCallr does not collect
              </a>
            </li>
            <li>
              <a href="#purposes" onClick={(e) => scrollToId(e, "purposes")} className="text-[#3DFFA0] hover:text-white hover:underline transition-colors block py-0.5">
                4. Purposes and legal bases
              </a>
            </li>
            <li>
              <a href="#retention" onClick={(e) => scrollToId(e, "retention")} className="text-[#3DFFA0] hover:text-white hover:underline transition-colors block py-0.5">
                5. Retention periods
              </a>
            </li>
            <li>
              <a href="#recipients" onClick={(e) => scrollToId(e, "recipients")} className="text-[#3DFFA0] hover:text-white hover:underline transition-colors block py-0.5">
                6. Recipients and processors
              </a>
            </li>
            <li>
              <a href="#transfers" onClick={(e) => scrollToId(e, "transfers")} className="text-[#3DFFA0] hover:text-white hover:underline transition-colors block py-0.5">
                7. Transfers outside the European Union
              </a>
            </li>
            <li>
              <a href="#security" onClick={(e) => scrollToId(e, "security")} className="text-[#3DFFA0] hover:text-white hover:underline transition-colors block py-0.5">
                8. Security
              </a>
            </li>
            <li>
              <a href="#rights" onClick={(e) => scrollToId(e, "rights")} className="text-[#3DFFA0] hover:text-white hover:underline transition-colors block py-0.5">
                9. Your rights
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="#changes" onClick={(e) => scrollToId(e, "changes")} className="text-[#3DFFA0] hover:text-white hover:underline transition-colors block py-0.5">
        ...
        <div className="space-y-12 leading-relaxed text-base">
          ...
          <section id="controller" className="scroll-mt-6">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-[#131E42] border border-[#263462] rounded-xl p-4 shadow-sm">
                <strong className="text-[#FFFFFF]">MOTIOON</strong>, a French simplified joint-stock company (SASU)<br />
          ...
          <section id="data" className="scroll-mt-6">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-bold text-[#FFFFFF] mb-2">2.1 Account data (all users)</h3>
                <ul className="list-disc pl-6 space-y-2">
                  <li><strong className="text-[#FFFFFF]">Identity:</strong> full name;</li>
                  <li><strong className="text-[#FFFFFF]">Contact details:</strong> email address, phone number;</li>
                  <li><strong className="text-[#FFFFFF]">Authentication:</strong> password (stored exclusively in encrypted/hashed form — we never have access to your password in plain text);</li>
                  <li><strong className="text-[#FFFFFF]">Account type:</strong> individual or professional.</li>
                </ul>
              </div>

              <div>
                <h3 className="text-lg font-bold text-[#FFFFFF] mb-2">2.2 Professional verification data (professional accounts only)</h3>
                <p>
              ...
              <div>
                <h3 className="text-lg font-bold text-[#FFFFFF] mb-2">2.3 Service usage data</h3>
                <ul className="list-disc pl-6 space-y-2">
                  <li><strong className="text-[#FFFFFF]">Secure contacts:</strong> the list of SafeCallr users with whom you have established a verification relationship;</li>
                  <li><strong className="text-[#FFFFFF]">Verification history:</strong> the date, counterpart and outcome (identity confirmed or not) of each authentication request;</li>
                  <li><strong className="text-[#FFFFFF]">Verification codes:</strong> the single-use codes generated during an authentication request, which expire automatically after a short period;</li>
                  <li><strong className="text-[#FFFFFF]">Preferences:</strong> application language.</li>
                </ul>
              </div>

              <div>
                <h3 className="text-lg font-bold text-[#FFFFFF] mb-2">2.4 Technical data</h3>
                <ul className="list-disc pl-6 space-y-2">
                  <li><strong className="text-[#FFFFFF]">Push notification token (FCM token):</strong> a technical identifier used to deliver authentication notifications to your device;</li>
                  <li><strong className="text-[#FFFFFF]">Platform used:</strong> iOS, Android or web;</li>
                  <li><strong className="text-[#FFFFFF]">Technical logs:</strong> connection and error logs strictly necessary for the operation, security and maintenance of the service.</li>
                </ul>
              </div>
            </div>
          </section>
              ...
              <table className="w-full text-left text-sm border-collapse">
                <thead>
                  <tr className="bg-[#182550] text-[#3DFFA0]">
                    <th className="p-4 font-semibold border-b border-[#263462]">Purpose</th>
                    <th className="p-4 font-semibold border-b border-[#263462]">Data concerned</th>
                    <th className="p-4 font-semibold border-b border-[#263462]">Legal basis (Art. 6 GDPR)</th>
                  </tr>
                </thead>
          ...
          <section id="retention" className="scroll-mt-6">
            ...
            <div className="overflow-x-auto border border-[#263462] rounded-xl shadow-sm bg-[#131E42]">
              <table className="w-full text-left text-sm border-collapse">
                <thead>
                  <tr className="bg-[#182550] text-[#3DFFA0]">
                    <th className="p-4 font-semibold border-b border-[#263462]">Data</th>
                    <th className="p-4 font-semibold border-b border-[#263462]">Retention period</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-[#263462] text-[#E8ECF7]">
                  <tr>
          ...
          <section id="recipients" className="scroll-mt-6">
            ...
            <div className="overflow-x-auto border border-[#263462] rounded-xl shadow-sm bg-[#131E42] mb-6">
              <table className="w-full text-left text-sm border-collapse">
                <thead>
                  <tr className="bg-[#182550] text-[#3DFFA0]">
                    <th className="p-4 font-semibold border-b border-[#263462]">Provider</th>
                    <th className="p-4 font-semibold border-b border-[#263462]">Role</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-[#263462] text-[#E8ECF7]">
                  <tr>
          ...
          <section id="rights" className="scroll-mt-6">
            ...
            <ul className="list-disc pl-6 space-y-2 mb-4">
              <li><strong className="text-[#FFFFFF]">Right of access:</strong> obtain a copy of the data we hold about you;</li>
              <li><strong className="text-[#FFFFFF]">Right to rectification:</strong> have inaccurate or incomplete data corrected;</li>
              <li><strong className="text-[#FFFFFF]">Right to erasure:</strong> request the deletion of your data, in particular by deleting your account;</li>
              <li><strong className="text-[#FFFFFF]">Right to restriction:</strong> request the temporary freezing of the processing of your data;</li>
              <li><strong className="text-[#FFFFFF]">Right to data portability:</strong> receive your data in a structured, commonly used format;</li>
              <li><strong className="text-[#FFFFFF]">Right to object:</strong> object to processing based on our legitimate interest, on grounds relating to your particular situation;</li>
              <li><strong className="text-[#FFFFFF]">Post-mortem directives:</strong> set directives regarding the fate of your data after your death, as provided under French law.</li>
            </ul>
            <p className="mb-3">
            ...
            <p>
              ...
              — CNIL, 3 place of Fontenoy, TSA 80715, 75334 Paris Cedex 07, France — or with the supervisory authority of your country of residence.
            </p>
          </section>
          ...
          <section id="age" className="scroll-mt-6">
            ...
            <p>
              SafeCallr is restricted to persons aged <strong className="text-[#FFFFFF]">18 or over</strong>. By creating an account, you confirm that you are at least 18 years old. If we become aware that an account has been created by a minor, we will delete it.
            </p>
          </section>
      ...
      {/* Footer */}
      <footer id="privacy-en-footer" className="border-t border-[#263462] py-8 px-6 text-center text-sm text-[#9FACD1] bg-[#0A1128]">
